...
import com.seonghun.herenthere.application.LoginService;
import com.seonghun.herenthere.application.LogoutService;
import com.seonghun.herenthere.dtos.LoginRequestDto;
...
public class SessionController {
    ...
    public LoginResultDto login(@RequestBody LoginRequestDto loginRequestDto) {
        LoginResultDto loginResult = loginService.login(loginRequestDto.email(), loginRequestDto.password());
        return loginResult;
    }
